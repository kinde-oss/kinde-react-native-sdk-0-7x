...
class KindeSDK {
  ...
  constructor(
    ...
    this.additionalParameters = checkAdditionalParameters(additionalParameters);
  ...
  async login(
    ...
    return auth.authenticate(this, true, 'login', additionalParametersMerged);
  }
  ...
  register(
    ...
    checkAdditionalParameters(additionalParameters);
    const auth = new AuthorizationCode();
    return auth.authenticate(this, true, 'registration', additionalParameters);
  }
