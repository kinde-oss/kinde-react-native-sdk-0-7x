 ...
 */
export function instanceOfCreateUserRequestIdentitiesInner(
    value: object
): boolean {
    let isInstance = true;
...
export function CreateUserRequestIdentitiesInnerFromJSON(
    json: any
): CreateUserRequestIdentitiesInner {
    return CreateUserRequestIdentitiesInnerFromJSONTyped(json, false);
}

export function CreateUserRequestIdentitiesInnerFromJSONTyped(
    json: any,
    ...
    return {
        ...
        details: !exists(json, 'details')
            ? undefined
            : CreateUserRequestIdentitiesInnerDetailsFromJSON(json['details'])
    };
}

export function CreateUserRequestIdentitiesInnerToJSON(
    value?: CreateUserRequestIdentitiesInner | null
): any {
    if (value === undefined) {
        return undefined;
    }
