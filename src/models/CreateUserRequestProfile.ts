...
export function CreateUserRequestProfileFromJSON(
    json: any
): CreateUserRequestProfile {
    return CreateUserRequestProfileFromJSONTyped(json, false);
}

export function CreateUserRequestProfileFromJSONTyped(
    json: any,
...
export function CreateUserRequestProfileToJSON(
    value?: CreateUserRequestProfile | null
): any {
    if (value === undefined) {
        return undefined;
    }
