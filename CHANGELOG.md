...
##### Important: iOS Deployment Target

- **Minimum iOS version is now 12.4+** — This SDK now uses `react-native-app-auth` for OAuth authentication, which depends on AppAuth-iOS. If your app previously targeted iOS versions below 12.4, update your `IPHONEOS_DEPLOYMENT_TARGET`.
